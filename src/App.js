...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://todolist-f16af-default-rtdb.europe-west1.firebasedatabase.app/items/.json')
  ...
  const deleteTodo = (id) => {
    fetch(`https://todolist-f16af-default-rtdb.europe-west1.firebasedatabase.app/items/${id}.json`,
    {
      method: 'DELETE',
    })
    .then(response => fetchItems())
